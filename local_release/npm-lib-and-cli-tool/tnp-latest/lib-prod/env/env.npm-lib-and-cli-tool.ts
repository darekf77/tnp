...
export const ENV_NPM_LIB_AND_CLI_TOOL_BUILD_PROD = true;
export const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_CLI_INCLUDE_NODE_MODULES = true;
export const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_LIB_DO_NOT_INCLUDE_LIB_FILES = true;
export const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_TARGET_ARTIFACT = 'npm-lib-and-cli-tool';
export const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_ENV_NAME = 'prod';
export const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_ENV_NUMBER = 1;
export const ENV_NPM_LIB_AND_CLI_TOOL_WEBSITE_DOMAIN = 'cli.taon.dev';
...
export const ENV_NPM_LIB_AND_CLI_TOOL_WEBSITE_TITLE = undefined;
