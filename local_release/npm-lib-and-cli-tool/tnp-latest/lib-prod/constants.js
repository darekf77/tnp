...
import { config, dockerTemplates, dotTaonFolder, fileName, folderName, taonContainers, } from 'tnp-core/lib-prod';
import { fse } from 'tnp-core/lib-prod';
import { ___NS__times, UtilsOs__NS__getRealHomeDir } from 'tnp-core/lib-prod';
import { crossPlatformPath, path, Utils__NS__uniqArray } from 'tnp-core/lib-prod';
import { CURRENT_PACKAGE_VERSION } from './build-info._auto-generated_';
// import type { Project } from './project/abstract/project';
//#endregion
export const whatToLinkFromCore = 'src/lib';
 ...
 */
export const whatToLinkFromCoreDeepPart = whatToLinkFromCore === 'src'
    ? ''
...
export const dirnameFromSourceToProject = (linkToSource) => {
...
export const COMPILATION_COMPLETE_LIB_NG_BUILD = 'Compilation complete. Watching for file changes';
...
export const DEFAULT_FRAMEWORK_VERSION = `v${CURRENT_PACKAGE_VERSION.split('.')[0]}`;
...
export var TempalteSubprojectType;
...
export const TempalteSubprojectTypeArr = [
...
export var TempalteSubprojectGroup;
...
export var AngularJsonTaskName;
...
export var DockerTemplatesFolders;
...
export var CoreNgTemplateFiles;
...
export var TaonGeneratedFolders;
...
export var AngularJsonAppOrElectronTaskName;
...
export const AngularJsonAppOrElectronTaskNameResolveFor = (envOptions) => {
...
export var AngularJsonLibTaskName;
...
export const AngularJsonLibTaskNameResolveFor = (envOptions) => {
    if (!envOptions.build.watch && !!envOptions.release.releaseType) {
 ...
 */
export function tempSourceFolder(appForLib, websql, prod = false) {
    if (appForLib && websql) {
...
export const updateVscodePackageJsonJsMainProject = 'update-vscode-package-json.js';
...
export const migration_index_autogenerated_ts = 'migrations_index._auto-generated_.ts';
export const migrationIndexAutogeneratedTsFileRelativeToSrcPath = crossPlatformPath([
    libFromSrc,
    migrationsFromLib,
    migration_index_autogenerated_ts,
]);
//# sourceMappingURL=c:/Users/darek/projects/npm/taon-dev/tnp/dist/lib-prod/constants.js.map