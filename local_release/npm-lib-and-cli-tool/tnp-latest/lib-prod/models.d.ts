import { LibTypeEnum, CoreModels__NS__EnvironmentName, CoreModels__NS__FrameworkVersion, CoreModels__NS__LibType } from 'tnp-core/lib-prod';
import { PackageJson } from 'tnp-helpers/lib-prod';
...
export type Models__NS__TestTypeTaon = 'mocha' | 'jest' | 'cypress';
export declare const Models__NS__TestTypeTaonArr: Models__NS__TestTypeTaon[];
export interface Models__NS__TaonLoaderConfig {
    name?: Models__NS__TaonLoaders;
    color?: string;
}
export type Models__NS__TaonLoaders = keyof typeof globaLoaders;
export type Models__NS__NewSiteOptions = {
    name?: string;
    cwd?: string;
};
export type Models__NS__RootArgsType = {
    ...
    findNearestProjectType: CoreModels__NS__LibType;
    findNearestProjectTypeWithGitRoot: CoreModels__NS__LibType;
    cwd: string;
};
export interface Models__NS__PsListInfo {
    pid: number;
    ppid: number;
    memory: number;
    cpu: number;
...
export interface Models__NS__CreateJsonSchemaOptions {
    project: Project;
    nameOfTypeOrInterface: string;
    relativePathToTsFile: string;
}
export declare class Models__NS__TaonContext {
    contextName: string;
    fileRelativePath: string;
}
export interface Models__NS__TaonAutoReleaseItem {
...
export type Models__NS__TaonArtifactInclude = ReleaseArtifactTaon[] | '*';
export interface Models__NS__TscCompileOptions {
    watch?: boolean;
...
export interface Models__NS__TaonJsonStandalone extends TaonJsonCommon {
    /**
    ...
    singleFileBundlingPackages: {
         ...
         */
        isExternalFor?: Models__NS__TaonArtifactInclude;
        /**
         * replace with nothing require('packageName') - if still is somewhere
         * is final code
         */
        replaceWithNothing?: Models__NS__TaonArtifactInclude;
        /**
         ...
         *
         */
        includeInBundleNodeModules?: Models__NS__TaonArtifactInclude;
    }[];
    /**
     ...
     */
    autoReleaseConfigAllowedItems?: Models__NS__TaonAutoReleaseItem[];
}
export interface Models__NS__TaonJsonContainer extends TaonJsonCommon {
    /**
...
export type Models__NS__TaonJsonCombined = Models__NS__TaonJsonStandalone & Models__NS__TaonJsonContainer;
export type Models__NS__TaonJson = TaonJsonCommon & (Models__NS__TaonJsonStandalone | Models__NS__TaonJsonContainer);
export interface Models__NS__DocsConfig {
    /**
