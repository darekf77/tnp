...
export class $Refactor extends BaseCli {
  ...
  async ng21() {
    ...
    tsFileContent = UtilsTypescript__NS__migrateFromNgModulesToStandaloneV21(
      tsFileContent,
      ___NS__upperFirst(___NS__camelCase(this.project.name)),
    );
    // import { RenderMode, ServerRoute } from '@angular/ssr';
    tsFileContent = UtilsTypescript__NS__addOrUpdateImportIfNotExists(
      tsFileContent,
