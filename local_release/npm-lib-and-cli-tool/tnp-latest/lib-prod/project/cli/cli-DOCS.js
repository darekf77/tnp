...
import { HelpersTaon__NS__CLIWRAP, UtilsHttp__NS__startHttpServer } from 'tnp-helpers/lib-prod';
...
class $Docs extends BaseCli {
    ...
    async envCheck(options) {
        ...
        console.log(`Environment for DOCS build is ${envOK ? chalk.green('OK') : chalk.red('NOT OK')}`);
        this._exit();
        //#endregion
    }
}
...
//# sourceMappingURL=c:/Users/darek/projects/npm/taon-dev/tnp/dist/lib-prod/project/cli/cli-DOCS.js.map