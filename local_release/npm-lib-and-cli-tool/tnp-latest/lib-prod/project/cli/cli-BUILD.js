//#region imports
import { ___NS__isFunction, UtilsTerminal__NS__select } from 'tnp-core/lib-prod';
import { Helpers__NS__clearConsole, Helpers__NS__info, HelpersTaon__NS__CLIWRAP } from 'tnp-helpers/lib-prod';
...
class $Build extends BaseCli {
    ...
    async _lib(prod = false) {
        await this.project.build(EnvOptions.from({
            ...this.params,
            build: {
                prod,
            },
    ...
    async mkdocs() {
        ...
        while (true) {
            ...
            const q = await UtilsTerminal__NS__select({
        ...
        if (___NS__isFunction(res.action)) {
            await res.action();
        }
        Helpers__NS__info('DONE BUILDING DOCS');
        this._exit();
    }
}
export default {
    $Build: HelpersTaon__NS__CLIWRAP($Build, '$Build'),
};
//# sourceMappingURL=c:/Users/darek/projects/npm/taon-dev/tnp/dist/lib-prod/project/cli/cli-BUILD.js.map