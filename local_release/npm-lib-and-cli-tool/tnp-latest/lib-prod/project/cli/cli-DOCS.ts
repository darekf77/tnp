...
class $Docs extends BaseCli {
  ...
  async serve() {
    ...
    await UtilsHttp__NS__startHttpServer(buildedDocsFolder, port, {
      startMessage: `
...
export default {
  $Docs: HelpersTaon__NS__CLIWRAP($Docs, '$Docs'),
};