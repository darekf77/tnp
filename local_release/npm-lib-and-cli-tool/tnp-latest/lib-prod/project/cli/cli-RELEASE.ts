...
class $Release extends BaseCli {
  ...
  async installLocally() {
    ...
    while (true) {
      option = await UtilsTerminal__NS__select<ReleaseArtifactTaon>({
        choices: options,
