import { Helpers__NS__error } from 'tnp-core/lib-prod';
import { BaseNpmHelpers, } from 'tnp-helpers/lib-prod';
import { NodeModules } from './node-modules';
import { PackageJSON } from './package-json';
//#endregion
// @ts-ignore TODO weird inheritance problem
export class NpmHelpers extends BaseNpmHelpers {
    _nodeModulesType = NodeModules;
    _packageJsonType = PackageJSON;
    // @ts-ignore TODO weird inheritance problem
    packageJson;
    // @ts-ignore TODO weird inheritance problem
    nodeModules;
    ...
    checkProjectReadyForNpmRelease() {
        ...
        Helpers__NS__error(`Project "${this.project.genericName}" can't be used in npm release`, false, true);
        //#endregion
    }
    //#endregion
...
//# sourceMappingURL=c:/Users/darek/projects/npm/taon-dev/tnp/dist/lib-prod/project/abstract/npm-helpers.js.map