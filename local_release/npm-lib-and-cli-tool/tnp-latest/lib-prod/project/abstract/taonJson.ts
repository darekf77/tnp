...
export class TaonJson extends BaseFeatureForProject<Project> {
  private readonly data?: Models__NS__TaonJson;
  ...
  constructor(project: Project, defaultValue?: Partial<Models__NS__TaonJson>) {
    ...
    if (!this.data && defaultValue) {
      this.data = ___NS__cloneDeep(defaultValue as any);
    }
  ...
  public reloadFromDisk(): void {
    //#region @backendFunc
    const newData =
      Helpers__NS__readJson5([this.project.pathFor(taonJsonMainProject)]) ||
      this.data;
  ...
  public preserveOldTaonProps(): void {
    ...
    const data = this.data as Models__NS__TaonJsonStandalone;
    ...
    if (this.project.framework.isStandaloneProject) {
      const dataToClean = this.data as Models__NS__TaonJsonContainer;
    ...
    if (!this.appId) {
      ...
      this.appId = Utils__NS__uniqArray(
        (
  ...
  public preservePropsFromPackageJson(): void {
    ...
    for (const prop of OVERRIDE_FROM_TNP) {
      if (
        ___NS__isUndefined(packageJsonOverrideData[prop]) &&
  ...
  public saveToDisk(purpose?: string): void {
    ...
    if (this.isCoreProject && this.project.framework.isContainer) {
      ...
      const sorted = Utils__NS__sortKeys(___NS__cloneDeep(this.data)) as typeof this.data;
  ...
  get type(): CoreModels__NS__LibType {
    ...
    if (___NS__isString(res)) {
      return res as CoreModels__NS__LibType;
    }
  ...
  get baseContentUrl(): string | undefined {
    //#region @backendFunc
    return (this.data as Models__NS__TaonJsonStandalone)?.baseContentUrl;
    //#endregion
  }
  //#endregion
  ...
  get baseImagesUrl(): string | undefined {
    //#region @backendFunc
    return (this.data as Models__NS__TaonJsonStandalone)?.baseImagesUrl;
    //#endregion
  }
  //#endregion
  ...
  get storeGeneratedAssetsInRepository(): boolean {
    ...
    return !!(this.data as Models__NS__TaonJsonStandalone)
  ...
  get dependenciesNamesForNpmLib(): string[] {
    //#region @backendFunc
    let res = (this.data as Models__NS__TaonJsonStandalone)
  ...
  get overridePackagesOrder(): string[] {
    //#region @backendFunc
    let res = (this.data as Models__NS__TaonJsonContainer)?.overridePackagesOrder;
    return res || [];
    //#endregion
  }
  //#endregion
  ...
  additionalExternalsFor(artifactName: ReleaseArtifactTaon): string[] {
    //#region @backendFunc
    let res = (
      this.data as Models__NS__TaonJsonStandalone
  ...
  setType(type: CoreModels__NS__LibType): void {
    //#region @backendFunc
    const data = this.data as Models__NS__TaonJsonContainer;
    Helpers__NS__info(
  ...
  async setFrameworkVersion(
    frameworkVersionArg: CoreModels__NS__FrameworkVersion,
  ): Promise<void> {
    //#region @backendFunc
  ...
  setShouldGenerateAutogenIndexFile(value: boolean) {
    const data = this.data as Models__NS__TaonJsonStandalone;
  ...
  get appId(): string {
    //#region @backendFunc
    return (this.data as Models__NS__TaonJsonStandalone)?.appId;
    //#endregion
  }
