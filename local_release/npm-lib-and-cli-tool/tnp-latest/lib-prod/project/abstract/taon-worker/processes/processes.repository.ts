...
export class ProcessesRepository extends TaonBaseRepository<Processes> {
  ...
  private processFileLoggers: {
    [processId: string]: UtilsProcessLogger__NS__ProcessFileLogger;
  } = {};
  //#endregion
