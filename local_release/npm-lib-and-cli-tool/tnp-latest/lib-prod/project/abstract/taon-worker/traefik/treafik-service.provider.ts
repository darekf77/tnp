...
export class TraefikServiceProvider {
  ...
  public getIpFromYml(): string | undefined {
    ...
    //#region @backendFunc
    const ymlFileAbsPath = ___NS__first(
