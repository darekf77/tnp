...
export class InstancesController extends TaonBaseCliWorkerController {
  ...
  @DELETE()
  delete(@Query('id') id: string): Taon__NS__Response<Instances> {
