import { CoreModels, LibTypeEnum } from 'tnp-core';
import { PackageJson } from 'tnp-helpers';
...
export declare namespace Models {
    ...
    export const TestTypeTaonArr: TestTypeTaon[];
    ...
    export type TaonArtifactInclude = ReleaseArtifactTaon[] | '*';
    ...
    export type TaonJson = TaonJsonCommon & (TaonJsonStandalone | TaonJsonContainer);
