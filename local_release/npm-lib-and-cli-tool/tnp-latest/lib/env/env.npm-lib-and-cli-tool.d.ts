export declare const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_CLI_INCLUDE_NODE_MODULES = true;
export declare const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_CLI_USE_LOCAL_RELEASE_BRANCH = true;
...
export declare const ENV_NPM_LIB_AND_CLI_TOOL_WEBSITE_DOMAIN = "cli.taon.dev";
...
export declare const ENV_NPM_LIB_AND_CLI_TOOL_BUILD_ELECTRON_SHOW_DEV_TOOLS: any;
export declare const ENV_NPM_LIB_AND_CLI_TOOL_BUILD_SSR: any;
export declare const ENV_NPM_LIB_AND_CLI_TOOL_BUILD_WEBSQL: any;
export declare const ENV_NPM_LIB_AND_CLI_TOOL_BUILD_PROD: any;
...
export declare const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_AUTO_RELEASE_TASK_NAME: any;
export declare const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_TAON_INSTANCE_IP: any;
export declare const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_SKIP_NPM_PUBLISH: any;
export declare const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_SKIP_DEPLOY: any;
...
export declare const ENV_NPM_LIB_AND_CLI_TOOL_RELEASE_PUSH_TO_ALL_ORIGINS_WHEN_LOCAL_RELEASE_BRANCH: any;
export declare const ENV_NPM_LIB_AND_CLI_TOOL_COPY_TO_MANAGER_BEFORE_COPY_HOOK: any;
...
export declare const ENV_NPM_LIB_AND_CLI_TOOL_WEBSITE_TITLE: any;
