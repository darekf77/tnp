...
export declare const DEFAULT_FRAMEWORK_VERSION: CoreModels.FrameworkVersion;
...
export declare const coreRequiredEnvironments: CoreModels.EnvironmentNameTaon[];
/**
