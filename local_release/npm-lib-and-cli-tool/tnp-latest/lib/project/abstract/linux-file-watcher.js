...
exports.LinuxFileWatcher = void 0;
...
class LinuxFileWatcher {
    ...
    async start() {
        ...
        this.sub = await (0, watcher_1.subscribe)(cwd, (err, events) => {
            if (err) {
...
exports.LinuxFileWatcher = LinuxFileWatcher;
//# sourceMappingURL=c:/Users/darek/projects/npm/taon-dev/tnp/dist/lib/project/abstract/linux-file-watcher.js.map