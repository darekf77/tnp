export declare enum ProcessesState {
    /**
...
export declare const ProcessesStatesAllowedStart: ProcessesState[];
export declare const ProcessesStatesAllowedStop: ProcessesState[];
