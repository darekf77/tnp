...
exports.activateMenuTnp = activateMenuTnp;
exports.deactivateMenuTnp = deactivateMenuTnp;
//#region imports
const lib_1 = require("tnp-core/lib");
const lib_2 = require("tnp-core/lib");
const constants_1 = require("./constants");
const project_1 = require("./project/abstract/project");
const vscode_menu_items_1 = require("./vscode-menu-items");
//#endregion
...
function activateMenuTnp(context, vscode, FRAMEWORK_NAME) {
    ...
    //#endregion
    const FRAMEWORK_NAME_UPPER_FIST = lib_2._.upperFirst(FRAMEWORK_NAME);
    ...
    class ProjectsTreeProvider {
        ...
        async getChildren(element) {
            ...
            const CURRENT_PROJECT = WORKSPACE_MAIN_FOLDER_PATH
                ? project_1.Project.ins.From(WORKSPACE_MAIN_FOLDER_PATH)
                : undefined;
            if (!CURRENT_PROJECT) {
            ...
            const MAP_PROJEC_FN = (project, nameIsFirst = false) => {
                ...
                const secondPartOfName = nameIsFirst
                    ...
                    : `${project.nameForNpmPackage.replace(parentName, `---`)}` +
                        ` ${project.name !== lib_1.path.basename(project.nameForNpmPackage) ? `(${project.name})` : ''}`;
            ...
            if (CURRENT_PROJECT.typeIs('unknown-npm-project')) {
                return [
                    ...
                    ...(0, vscode_menu_items_1.vscodeMenuItems)({
                        vscode,
                        FRAMEWORK_NAME,
                        CURRENT_PROJECT,
                        runInTerminal,
                        focustFirstElement,
                        ProjectItem,
                        tmp_FRONTEND_NORMAL_APP_PORT: constants_1.tmp_FRONTEND_NORMAL_APP_PORT,
                        tmp_FRONTEND_WEBSQL_APP_PORT: constants_1.tmp_FRONTEND_WEBSQL_APP_PORT,
                        skipTaonItems: true,
                    }),
                    // children
...
//# sourceMappingURL=c:/Users/darek/projects/npm/taon-dev/tnp/dist/lib/vscode-ext-menu.js.map