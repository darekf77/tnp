...
declare class EnvOptionsRelease {
     ...
     */
    overrideStaticPagesReleaseType: CoreModels.ReleaseVersionType;
    /**
     ...
     * Local release to special branch
     */
    pushToAllOriginsWhenLocalReleaseBranch?: boolean;
...
export declare class EnvOptions<ENV_CONFIG = Record<string, string | number | boolean | null>> {
    ...
    readonly name?: CoreModels.EnvironmentNameTaon;
    readonly currentProjectName?: string;
    readonly currentProjectType?: CoreModels.LibType;
