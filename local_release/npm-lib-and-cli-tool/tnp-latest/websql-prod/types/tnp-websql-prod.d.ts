 ...
 * readonly __refSync: import("taon/websql-prod").EndpointContext;
 * instead of
...
declare class TaonProjectsController extends TaonBaseCliWorkerController {
    taonEnvRepo: taon_websql_prod.TaonBaseRepository<TaonEnv>;
