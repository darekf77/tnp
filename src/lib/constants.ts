...
export enum TaonGeneratedFiles {
  ...
  BUILD_STATUS_MD = 'BUILD-STATUS.md',
...
export const tsconfigBackendEsmDistJson = 'tsconfig.backend-esm.dist.json';

export const tsconfigBackendDistJson_PROD = 'tsconfig.backend.dist.prod.json';
export const tsconfigBackendEsmDistJson_PROD =
  'tsconfig.backend-esm.dist.prod.json';
...
export const ERR_MESSAGE_PROJECT_ALREADY_PART_OF_BUILD =
  'PROJECT_ALREADY_PART_OF_BUILD';
...
export const debugModeTaonLightWeightWatchMode = false;

export const DEBOUCE_takeLeadOfBuildingDebounce = 500;

export const DEBOUNCE_trigerLeadBuilding = 200;

export const DEBOUNCE_notifyLeaderAboutBuildDone = 200;
...
export const i18nFolder = 'i18n';

export const i18nDataTsFileExt = '.i18n.data.ts';
