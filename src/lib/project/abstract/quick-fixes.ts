...
Put your backend **vite** tests (with *.test.ts extension) in this folder..

# How to test your isomorphic backend ?

- open file in vscode
- Select "Debug And Run" icon
- Select "Run Vitest (editor active test file)"

ps. you can create .test.ts files anywhere, but this folder is just for tests.
...
${THIS_IS_GENERATED_STRING}`,
  ...
  //#region update tailwind options
  updateTailwindCssContent(
    tailWindFileNgProjAbsPath: string,
    ...
    const globalScssContentWithoutComments = (
