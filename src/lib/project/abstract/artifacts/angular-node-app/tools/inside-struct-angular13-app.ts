...
`;
          ...
          (() => {
            ...
            (() => {
              ...
              const loaderData =
                this.project.env.loading.afterAngularBootstrap.loader;
            ...
            (() => {
              ...
              const bgColor =
                this.project.env.loading.afterAngularBootstrap.background;
            ...
            (() => {
              ...
              const loaderData =
                this.project.env.loading.preAngularBootstrap.loader;
              ...
              const bgColor =
                this.project.env.loading.preAngularBootstrap.background;
          ...
          (() => {
            ...
            const title = this.project.env.website.title;
          ...
          await (async () => {
            ...
            manifestJson.name =
              this.project.env.build.pwa.name || _.startCase(project.name);

            manifestJson.short_name =
              this.project.env.build.pwa.short_name || project.name;
            ...
            if (this.project.env.build.pwa.start_url) {
              manifestJson.start_url = this.project.env.build.pwa.start_url;
            } else if (this.project.env.website.useDomain) {
              manifestJson.start_url = `https://${this.project.env.website.domain}/`;
            } else {
